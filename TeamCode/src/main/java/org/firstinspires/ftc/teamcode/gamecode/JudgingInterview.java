    ...
    public void loopOpMode() {
        ...
        if(joy1.buttonA()) {
            ...
            text.speak("Now, if Helen will rotate me, you will see my foam button pressers." +
                    "Last but not least, this is my cap ball lifter.", TextToSpeech.QUEUE_FLUSH, null);
            while (opModeIsActive() && text.isSpeaking()) {
                idle();
            }
            ...
            text.speak("I also have had some problems with balls getting in front me so I use my whiskers to clear balls from in front of the beacons", TextToSpeech.QUEUE_FLUSH, null);
